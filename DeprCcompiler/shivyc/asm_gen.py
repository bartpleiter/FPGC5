...
class ASMCode:
    ...
    def full_code(self, compileForBDOS, compileOS):  # noqa: D202
        ...
        Different wrapper is used when compiled for BDOS
        ...
        # Wrapper for BDOS User programs
        ASMwrapper1BDOS = """
...
Main:
    load32 0x73FFFF rsp     ; initialize user main stack address
...
"""
        ...
        # Wrapper for BDOS and bare metal programs
        ASMwrapper1 = """
...
Int1:
    ...
    load32 0x7BFFFF rsp     ; initialize user int stack address
...
"""
        ...
        if compileForBDOS:
            returnCode = ASMwrapper1BDOS + fullCode + ASMwrapper2BDOS
        else:
            returnCode = ASMwrapper1 + fullCode + ASMwrapper2

        if compileOS:
            returnCode = returnCode + ASMwrapper3OS
